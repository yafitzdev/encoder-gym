...
impl ArtifactKind {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::BenchmarkArchitectBrief => "benchmark_architect_brief",
            Self::BenchmarkArchitectRun => "benchmark_architect_run",
            Self::BenchmarkArchitectEvidence => "benchmark_architect_evidence",
            Self::BenchmarkArchitectureProposal => "benchmark_architecture_proposal",
            Self::BenchmarkArchitectureReview => "benchmark_architecture_review",
            Self::BenchmarkAcquisitionHandoff => "benchmark_acquisition_handoff",
