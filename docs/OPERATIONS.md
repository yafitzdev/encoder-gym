...
loads a checkpoint or runs inference. See `features/evaluation/error-analysis.md`.

## Advisory optimization

```text
synth optimize preview <REPORT_ID> --protocol <PROTOCOL.toml>
synth optimize scenarios <REPORT_ID> --protocol <PROTOCOL.toml>
synth optimize propose <REPORT_ID> --protocol <PROTOCOL.toml>
...
`features/optimization/optimization.md`.
...
cancellation between bounded batches. See `docs/features/training/transformer-training.md` for
...
`docs/features/optimization/encoder-optimize.md`.
