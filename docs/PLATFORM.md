...
early milestones of [Benchmark Stewardship](features/evaluation/benchmark-stewardship-spec.md).
...
[Authenticity Research Agent](features/research/research-agent-spec.md).
...
plan. See [Dataset Architect](features/datasets/dataset-architect-spec.md).
...
[Dataset Qualification and Curation](features/datasets/dataset-quality-spec.md).
...
[Generation Quality Supervisor](features/generation/generation-quality-supervisor-spec.md).
...
[Governed Workflow Generation Supervision](features/generation/workflow-generation-supervision-spec.md).
...
- [Authenticity Research Agent](features/research/research-agent-spec.md)
- [Dataset Architect](features/datasets/dataset-architect-spec.md)
- [Dataset Qualification and Curation](features/datasets/dataset-quality-spec.md)
- [Generation Quality Supervisor](features/generation/generation-quality-supervisor-spec.md)
- [Governed Workflow Generation Supervision](features/generation/workflow-generation-supervision-spec.md)
- [Benchmark Stewardship](features/evaluation/benchmark-stewardship-spec.md)
- [Benchmark Architect](features/evaluation/benchmark-architect-spec.md)

Cross-slice composition is specified separately in
[Controlled Workflow and Evaluation Governance](features/governance/workflow-governance-spec.md).
...
[Production Encoder Experiments](features/optimization/production-encoder-experiment-spec.md).
...
[Finite Encoder Optimization](features/optimization/encoder-optimize.md) and
[Current Evaluation Evidence](evaluation/current.md).
