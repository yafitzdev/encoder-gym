...
The protocol file is strict: unknown fields,
...
```text
synth optimize preview <ANALYSIS_REPORT_ID> --protocol <PROTOCOL.toml>
synth optimize propose <ANALYSIS_REPORT_ID> --protocol <PROTOCOL.toml>
```
...
```text
synth optimize scenarios <ANALYSIS_REPORT_ID> --protocol <PROTOCOL.toml>
