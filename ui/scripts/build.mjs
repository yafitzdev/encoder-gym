...
for (const module of ["projects", "project-registry", "managed-backend", "managed-datasets", "managed-benchmarks", "managed-optimization-setup", "managed-optimization-launch", "credential-store", "presentation-errors", "run-activity"]) await build({
