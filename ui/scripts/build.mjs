...
for (const module of ["projects", "project-registry", "managed-backend", "managed-datasets", "managed-benchmarks", "managed-optimization-setup", "managed-optimization-launch", "optimization-preparation", "input-optimization", "credential-store", "presentation-errors", "run-activity"]) await build({
