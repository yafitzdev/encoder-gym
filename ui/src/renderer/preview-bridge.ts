...
export function previewBridge(): EncoderGymBridge {
  ...
  return {
    agentFinalResult: unavailable, reviewAgentFinal: unavailable, authorizeAgentFinal: unavailable,
    recoverAgentFinal: unavailable, stopAgentFinal: unavailable, promoteAgentFinal: unavailable,
    ...
    providerConnections: unavailable, addProviderConnection: unavailable, refreshProviderConnection: unavailable, removeProviderConnection: unavailable, assignProviderModels: unavailable,
