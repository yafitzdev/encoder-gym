...
export function recordProgress(activity: RunActivity, progress: NativeProgress, at = new Date().toISOString()): void {
  ...
  Object.assign(activity, { ...progress, completed: progress.completed, total: progress.total, subject: progress.subject, unit: progress.unit, narrative: progress.narrative, training: progress.training, updatedAt: at });
}
