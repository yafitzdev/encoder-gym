...
test("sealed scores and secret parameters never reach the read model", () => {
  const f = fixture();
  const r = projectRun(f.protocol, f.project, f.events, "test.sqlite");
